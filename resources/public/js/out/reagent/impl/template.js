...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__16935__auto__,writer__16936__auto__,opt__16937__auto__){
return cljs.core._write.call(null,writer__16936__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__16337__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__16337__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__16337__auto__)){
return or__16337__auto__;
} else {
...
var G__24681 = o;
(G__24681[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__24682__delegate = function (args){
...
while (G__24683__i < G__24683__a.length) {G__24683__a[G__24683__i] = arguments[G__24683__i + 0]; ++G__24683__i;}
  args = new cljs.core.IndexedSeq(G__24683__a,0);
} 
return G__24682__delegate.call(this,args);};
G__24682.cljs$lang$maxFixedArity = 0;
G__24682.cljs$lang$applyTo = (function (arglist__24684){
var args = cljs.core.seq(arglist__24684);
return G__24682__delegate(args);
});
...
var old_24685 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_24685))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_24685)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__16325__auto__ = (node === document.activeElement);
if(and__16325__auto__){
var and__16325__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__16325__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__24688 = jsprops;
(G__24688["defaultValue"] = value);

(G__24688["onChange"] = ((function (G__24688,v,value,on_change){
return (function (p1__24686_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__24686_SHARP_);
});})(G__24688,v,value,on_change))
);
...
var vec__24690 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__24690,(0),null);
var id = cljs.core.nth.call(null,vec__24690,(1),null);
var class$ = cljs.core.nth.call(null,vec__24690,(2),null);
...
var temp__4427__auto__ = (function (){var G__24694 = cljs.core.meta.call(null,v);
var G__24694__$1 = (((G__24694 == null))?null:reagent.impl.template.get_key.call(null,G__24694));
return G__24694__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__24696_24697 = v;
var G__24696_24698__$1 = (((G__24696_24697 == null))?null:reagent.impl.template.key_from_vec.call(null,G__24696_24697));
var G__24696_24699__$2 = (((G__24696_24698__$1 == null))?null:(jsprops["key"] = G__24696_24698__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__24702 = cljs.core.meta.call(null,argv);
var G__24702__$1 = (((G__24702 == null))?null:reagent.impl.template.get_key.call(null,G__24702));
return G__24702__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__24703 = (((jsprops == null))?{}:jsprops);
(G__24703["key"] = key);
...
var G__24704 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__24704;
continue;
}
} else {
...
var n__17240__auto___24705 = a.length;
var i_24706 = (0);
while(true){
if((i_24706 < n__17240__auto___24705)){
(a[i_24706] = reagent.impl.template.as_element.call(null,(a[i_24706])));

var G__24707 = (i_24706 + (1));
i_24706 = G__24707;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__17240__auto___24708 = a.length;
var i_24709 = (0);
while(true){
if((i_24709 < n__17240__auto___24708)){
var val_24710 = (a[i_24709]);
if((cljs.core.vector_QMARK_.call(null,val_24710)) && ((reagent.impl.template.key_from_vec.call(null,val_24710) == null))){
(o["no-key"] = true);
} else {
}

(a[i_24709] = reagent.impl.template.as_element.call(null,val_24710));

var G__24711 = (i_24709 + (1));
i_24709 = G__24711;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__16325__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__16325__auto__){
return (ctx["no-key"]);
} else {
return and__16325__auto__;
...
var G__24713 = (cljs.core.count.call(null,argv) - first_child);
switch (G__24713) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__24713){
...
//# sourceMappingURL=template.js.map?rel=1443563486991